...
import { Account, CalendarEntry, Category, Customer, File, Internal, Price, Product, Project, Recipient, Transaction } from '@household/shared/types/types';
...
export const getCalendarEntryId = (doc: CalendarEntry.Document | Types.ObjectId): CalendarEntry.Id => getId(doc) as CalendarEntry.Id;
