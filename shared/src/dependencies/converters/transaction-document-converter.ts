...
export const transactionDocumentConverter = transactionDocumentConverterFactory(accountDocumentConverter, projectDocumentConverter, categoryDocumentConverter, recipientDocumentConverter, productDocumentConverter, paymentTransactionDocumentConverter, splitTransactionDocumentConverter, deferredTransactionDocumentConverter, reimbursementTransactionDocumentConverter, transferTransactionDocumentConverter);
