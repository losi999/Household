...
export const expect = baseExpect.extend({
  toHaveBeenImportedFromRevolutFile(draftTransactions: Transaction.DraftDocument[], fileId: Api.File.Id, ...revolutRows: Import.Revolut[]) {
  ...
  toHaveBeenImportedFromOtpFile(draftTransactions: Transaction.DraftDocument[], fileId: Api.File.Id, ...otpRows: Import.Otp[]) {
    const errors = draftTransactions.flatMap((document, index) => {
  ...
  toHaveBeenImportedFromErsteFile(draftTransactions: Transaction.DraftDocument[], fileId: Api.File.Id, ...ersteRows: Import.Erste[]) {
    const errors = draftTransactions.flatMap((document, index) => {
