...
export const selectCustomerIsInProgress = (customerId: Customer.Id) => createSelector(
  selectProgress, ({ inProgressCustomers }) => {
    return inProgressCustomers.includes(customerId);
  },
);
