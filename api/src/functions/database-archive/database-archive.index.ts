...
const databaseArchiveService = databaseArchiveServiceFactory(accountService, projectService, categoryService, recipientService, transactionService, productService, databaseArchiveStorageService);
