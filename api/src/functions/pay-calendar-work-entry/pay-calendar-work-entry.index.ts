...
import { default as body } from '@household/shared/schemas/calendar-entry-payment-request';
import { default as pathParameters } from '@household/shared/schemas/calendar-entry-id';
import { default as index } from '@household/api/handlers/index.handler';
import { authorizer } from '@household/api/dependencies/handlers/authorizer.handler';
import { UserType } from '@household/shared/enums';
import { payCalendarWorkEntryServiceFactory } from '@household/api/functions/pay-calendar-work-entry/pay-calendar-work-entry.service';
...
const payCalendarWorkEntryService = payCalendarWorkEntryServiceFactory(calendarEntryService, paymentTransactionDocumentConverter, settingService, accountService, categoryService, calendarEntryDocumentConverter);

export default index({
  handler: handler(payCalendarWorkEntryService),
  before: [
