...
export const customerActions = createActionGroup({
  ...
  events: {
    ...
    'Delete customer': props<Customer.Response>(),
    ...
    'Delete customer from blacklist': props<Customer.CustomerId & {selectedCustomer: Customer.ResponseBase}>(),
  },
});
...
export const customerApiActions = createActionGroup({
  ...
  events: {
    ...
    'Update customer failed': props<Customer.CustomerId>(),
